...
def addLettersToMapping(letterMapping, cipherword, candidate):
    ...
    # The cnditate parameter is a possible English word that the
...
def intersectMappings(mapA, mapB):
    ...
    for letter in LETTERS:
        ...
        # An empty list means "any letter is possible". In this case jsut
        ...
        if mapA[letter] == []:
            ...
            # If a letter in mapA[letter] exist in mapB[letter], add
            # that letter intersectedMapping[letter].
...
def removeSolvedLettersFromMapping(letterMapping):
    ...
    # "solved" and can be removesd from the other letters.
    ...
    letteMapping = copy.deepcopy(letterMapping)
    loopAgain = True
    while loopAgain:
        ...
        # deryption letter for a different ciphertext letter, so we
...
def hackSimpleSub(message):
    ...
    # Remov any solved letters from the other lists.
    return removeSolvedLettersFromMapping(intersectedMap)

def decryptWithCipherletterMapping(ciphertext, letterMapping):
    # Return a string of the ciphertext decrypted with the letter mapping.
    # with any ambiguous decrypted letters replaced with an _ undescore.
